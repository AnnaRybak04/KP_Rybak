...
class FavoriteState extends Equatable {
  ...
  FavoriteState copyWith({
    ...
    String?
        errorMessage, // Нове повідомлення про помилку (необов'язковий параметр)
    List<MovieItem>? movies, // Новий список фільмів (необов'язковий параметр)
    List<TVShowItem>?
        tvShows, // Новий список телепередач (необов'язковий параметр)
  }) {
    return FavoriteState(
      status: status ??
          this.status, // Якщо новий статус не передано, беремо поточний
      errorMessage: errorMessage ??
          this.errorMessage, // Якщо нове повідомлення про помилку не передано, беремо поточне
      movies: movies ??
          this.movies, // Якщо новий список фільмів не передано, беремо поточний
      tvShows: tvShows ??
          this.tvShows, // Якщо новий список телепередач не передано, беремо поточний
    );
  }
}
