...
// Клас стану сторінки фільмів
class _MoviesPageState extends State<MoviesPage> {
  // Блок для управління станом фільмів
  ...
  void initState() {
    super.initState();
    // Додаємо прослуховувач запитів на сторінки
  ...
  @override
  void dispose() {
    // Звільняємо ресурси контролера прокрутки
    controller.dispose();
    super.dispose();
  }
                ...
                child: FadingEdgeScrollView.fromScrollView(
                  ...
                  child: PagedGridView(
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      mainAxisSpacing: 8,
                      childAspectRatio:
                          2 / 3, // Змініть цей відношення на ваш розмір
                    ),
                    builderDelegate: PagedChildBuilderDelegate<MovieItem>(
                      ...
                      itemBuilder: (context, item, index) {
                        return Padding(
                          ...
                          child: OneMediaCard(
                            onTap: () {
                              // Передаємо ідентифікатор фільму до кубіту деталей медіа
