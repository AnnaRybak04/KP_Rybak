...
class MoviesState extends Equatable {
  ...
  final PagingController<int, MovieItem>
      moviesPagingController; // Контролер для сторінкованого завантаження фільмів
  ...
  MoviesState copyWith({
    ...
    PagingController<int, MovieItem>?
        moviesPagingController, // Новий контролер для сторінкованого завантаження фільмів
  }) {
    return MoviesState(
      status: status ??
          this.status, // Встановлення нового статусу або залишення поточного
      errorMessage: errorMessage ??
          this.errorMessage, // Встановлення нового повідомлення про помилку або залишення поточного
      moviesPagingController: moviesPagingController ??
          this.moviesPagingController, // Встановлення нового контролера або залишення поточного
    );
  }
}
