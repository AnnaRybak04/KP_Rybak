      ...
      children: [
        Column(
          children: [
            ...
            // Віджет панелі навігації для настільного додатку
              const SizedBox(height: DimensionConstants.appBarHeight, child: OneAppBar())
            else
              const SizedBox(),
        ...
        if (LayoutHelper.isDesktopScreen(context))
          Positioned(
            right: PaddingConstants.extraImmense * 2.5, // Позиціонування праворуч від панелі навігації
            child: SearchPage(controller: controller), // Сторінка пошуку з переданим контролером
