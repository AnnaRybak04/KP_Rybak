...
class _RemoteDatasource implements RemoteDatasource {
  // Конструктор класу _RemoteDatasource, приймає Dio для виконання запитів та базовий URL.
  _RemoteDatasource(
    this._dio, {
    this.baseUrl,
  }) {
...
// Отримати деталі конкретного телесеріалу за його id.
  @override
...
// Метод для встановлення типу відповіді (plain або json) в залежності від типу T
  ...
  // Метод для комбінування базового URL
