extension ListExtension<T> on List<T> {
  ...
  // Повертає останній елемент, який задовольняє умову, або null, якщо жоден елемент не задовольняє умову.
  ...
  // Повертає перший елемент списку або null, якщо список порожній.
  T? get firstOrNull {
  ...
  // Видаляє зі списку елементи, які містяться в заданому списку.
