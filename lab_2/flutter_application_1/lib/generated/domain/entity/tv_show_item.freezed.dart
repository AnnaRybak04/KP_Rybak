...
part of '../../../domain/entity/tv_show_item.dart';
...
mixin _$TVShowItem {
  ...
  List<String> get productionCountries => throw _privateConstructorUsedError;
  List<String> get productionCompanies => throw _privateConstructorUsedError;
...
class _$TVShowItemImpl extends _TVShowItem {
  _$TVShowItemImpl(
      {required this.id,
  ...
  @override
  List<String> get productionCompanies {
  ...
  @override
  String toString() {
    return 'TVShowItem(id: $id, originalName: $originalName, language: $language, overview: $overview, posterPath: $posterPath, voteAverage: $voteAverage, voteCount: $voteCount, releaseDate: $releaseDate, popularity: $popularity, status: $status, episodeRunTime: $episodeRunTime, genres: $genres, productionCountries: $productionCountries, productionCompanies: $productionCompanies)';
  }
...
abstract class _TVShowItem extends TVShowItem {
  factory _TVShowItem(
      ...
      required final List<String> genres,
      required final List<String> productionCountries,
      required final List<String> productionCompanies}) = _$TVShowItemImpl;
  _TVShowItem._() : super._();
