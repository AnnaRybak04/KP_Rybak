...
class _OneTextFieldState extends State<OneTextField> {
  ...
  Widget _buildBody() {
    return TextFormField(
      ...
      cursorColor: widget.cursorColor ?? theme.colorScheme.onSurface,
      expands: false,
      ...
      decoration: widget.textFieldDecoration ??
          InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: widget.borderRadius ?? BorderRadius.circular(BorderRadiusConstants.large),
              borderSide: widget.focusedBorderSide ?? BorderSide(color: theme.colorScheme.primary),
            ),
            ...
            hintStyle: widget.textStyle?.copyWith(color: theme.colorScheme.primary) ??
