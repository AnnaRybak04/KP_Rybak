...
class MediaDetailsCubit extends Cubit<MediaDetailsState> {
  ...
  void setMovie(int id) async {
    ...
    final MovieItem savedMovie = await localRepository.getRatingMovie(id);
  ...
  void setTVShow(int id) async {
    ...
    final TVShowItem savedTvShow = await localRepository.getRatingTVShow(id);
  ...
  void onRatingMovie(MovieItem movie, double rating) async {
    await localRepository.saveRatingMovie(movie.copyWith(rating: rating));
  ...
  void onRatingTVShow(TVShowItem tvShow, double rating) async {
    await localRepository.saveRatingTVShow(tvShow.copyWith(rating: rating));
    emit(state.copyWith(rating: rating));
  }
}
