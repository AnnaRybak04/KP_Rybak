...
part of '../../../domain/entity/movie_item.dart';
...
class _$MovieItemImpl extends _MovieItem {
  _$MovieItemImpl(
      {required this.id,
      required this.title,
  ...
  @override
  String toString() {
    return 'MovieItem(id: $id, title: $title, language: $language, originalTitle: $originalTitle, overview: $overview, posterPath: $posterPath, voteAverage: $voteAverage, voteCount: $voteCount, releaseDate: $releaseDate, popularity: $popularity, status: $status, tagline: $tagline, productionCountries: $productionCountries, productionCompanies: $productionCompanies, genres: $genres, budget: $budget, rating: $rating)';
  }
...
abstract class _MovieItem extends MovieItem {
  factory _MovieItem(
      ...
      required final double rating}) = _$MovieItemImpl;
