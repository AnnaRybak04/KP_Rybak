...
class TVShowsGrid extends StatefulWidget {
  ...
  TVShowsGrid({required Key key, required this.snapshot}) : super(key: key);

  @override
  _TVShowsGridState createState() => _TVShowsGridState();
}

class _TVShowsGridState extends State<TVShowsGrid> {
